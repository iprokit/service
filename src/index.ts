// Export HTTP.
export { Method as HttpMethod, StatusCode as HttpStatusCode, RequestHeaders, ResponseHeaders } from './http.common';
...
export { RFI, Mode as ScpMode, Parameters, Incoming, Outgoing } from './scp.common';
